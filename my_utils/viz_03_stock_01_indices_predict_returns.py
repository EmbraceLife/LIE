...
ax1.plot(target_closes, c='blue', label='index500') # change index name
...
ax3.set_title('model3 add trading cost') # change model name

plt.tight_layout()
# plt.show()
plt.savefig("/Users/Natsume/Downloads/data_for_all/stocks/model_performance/index500_model3_addcost.png")

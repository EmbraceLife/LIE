...
###########################
# how constraints.deserialize and serialize work
###########################
  ...
  def test_serialization(self):
    ...
    for name in all_activations:
      ...
      fn = keras.constraints.get(name)
	  	# getattr() to access func from module
      ref_fn = getattr(keras.constraints, name)()
      assert fn.__class__ == ref_fn.__class__
	  	# how to use serialize() to get config
      config = keras.constraints.serialize(fn)
	  	# from config to access function
...
kct = KerasConstraintsTest() # run through, no dive

# how to use get(), deserialize(), serialize()
kct.test_serialization()

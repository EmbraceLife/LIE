...
class Executor:
    ...
    def compile(self, target=None, recompile=False, with_provider=None,
                **kwargs):
        """ 1. set target to train, test or evaluate; 2. make sure Executor.model is built before compilation; 3. Compiles a model using keras backend; 4. dive into keras.backend.compile, additional dataset is handled
        ...
        # make sure Executor.model is built before compilation
        ...
        # dive in: check module, check line number
